...
<module xmlns="urn:jboss:module:1.1" name="de.smartics.test.extension">
  <resources>
    <resource-root path="extension-testing.jar" />
  </resources>
  <dependencies>
