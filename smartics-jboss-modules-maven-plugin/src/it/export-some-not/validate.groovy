...
assert '' == mods[2].@export.text()
assert '' == mods[3].@export.text()
assert '' == mods[4].@export.text()
assert '' == mods[5].@export.text()
assert '' == mods[6].@export.text()
assert '' == mods[7].@export.text()
assert '' == mods[8].@export.text()
assert '' == mods[9].@export.text()
assert '' == mods[10].@export.text()
